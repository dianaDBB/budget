...
public class CreditoAgricolaFileIT extends BaseIT {
    ...
    void shouldUploadFileAndReturnValidXlsx() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("Test Transaction", -50.00)));
    ...
    void shouldCategorizeGroceryTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("COMPRA CONTINENTE Store", 45.50, "D")));
    ...
    void shouldCategorizeDiningOutTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("UBER    EATS Restaurant", 22.30, "D")));
    ...
    void shouldCategorizeStreamingTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("NETFLIX Subscription", 12.99, "D")));
    ...
    void shouldCategorizeHealthTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("FARMACIA Pharmacy", 18.50, "D")));
    ...
    void shouldCategorizeGymTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("BALTAREJO Gym", 49.99, "D")));
    ...
    void shouldCategorizeInternetTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("VODAFONE Internet", 35.99, "D")));
    ...
    void shouldCategorizePhoneTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("NOS COM Phone", 40.50, "D")));
    ...
    void shouldCategorizeFuelTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("GALP Fuel Station", 60.00, "D")));
    ...
    void shouldCategorizeTollsTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("VIA VERDE Toll", 8.50, "D")));
    ...
    void shouldCategorizeSuppliesTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("COMPRA STAPLES Supplies", 25.75, "D")));
    ...
    void shouldCategorizeFeesTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("COMISSÃO S/ Bank Fee", 2.50, "D")));
    ...
    void shouldNotCategorizeUnknownTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("Unknown Random Purchase", 99.99, "D")));
    ...
    void shouldClassifyIncomeTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("EUR Deposit Income", 1000.00, "C")));
    ...
    void shouldClassifyExpenseTransaction() throws Exception {
        File inputFile = CreditoAgricola.createValidFile(List.of(new EntryDto("Random Purchase Expense", 75.50, "D")));
