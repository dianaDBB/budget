...
import static com.budget.apis.ActivoBankApi.*;
...
public class ActivoBankFileIT extends BaseIT {
    ...
    void shouldReturnErrorWhenFileIsEmpty() throws Exception {
        ...
        // When I try to upload it to the activoBank endpoint
        ...
        // Then it should fail with error code
    ...
    void shouldReturnErrorWhenFileHasInvalidFormat() throws Exception {
        ...
        File invalidFile = createActivoBankInvalidFile("this is not a number");
